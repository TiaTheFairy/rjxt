...
app_view = new Vue({
  ...
  data: {
    ...
    parts: ['电机', '电机支架', '齿轮箱', '齿轮箱支架', '轴护罩', '轴承', '基坑里衬', '叶轮', '下支撑环'],
    parts_id: ['PRT0172_1090', 'PRT0161_1036', 'PRT0164_1028', 'PRT0026_159', 'PRT0039_230', 'PRT0000_0000', 'PRT0043_234', 'PRT0149_912', 'PRT0103_683'],
  ...
  methods: {
    ...
    changePartsColor: function (index, e) {
      ...
      //changePartColor(this.parts_id[index], this.view_color_hex[i]);
    },
